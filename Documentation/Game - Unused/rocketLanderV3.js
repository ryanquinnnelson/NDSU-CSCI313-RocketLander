...
function startGame(){
    ...
    createjs.Ticker.addEventListener("tick", gameManager.updateGame());

    window.onkeydown = gameManager.handleKeyDown;
    window.onkeyup = gameManager.handleKeyUp;
}
...
function build_GameManager(){
    ...
    gameManager = new objects.GameManager();
}
